...
// ═══════════════════════════════════════════════════════════════════════════════
//  config.example.h  –  Astro Micro Station · T-Display S3 Pro
//  Copy this file to config.h. Credentials go in secrets.h — see secrets_template.h.
// ═══════════════════════════════════════════════════════════════════════════════
...
#define MQTT_TOPIC_STATUS "astronomy"   // base topic — data published to astronomy/sun, /moon, /morning, /evening
